...
//            createRequest.setTemplateBody(convertStreamToString(CloudFormationSample.class.getResourceAsStream("/CloudFormationSample.template")));
            createRequest.setTemplateBody(convertStreamToString(CloudFormationSample.class.getResourceAsStream("/SampleRailsApp.template")));


            Parameter parameter = new Parameter();
            parameter.setParameterKey("KeyName");
            parameter.setParameterValue("this_should_be_your_pair_name");
